...
from: https://github.com/green-fox-academy/final-exam-homework-mod/blob/master/backend-spec.md (private)
...
### As a signed in user I can create a sellable item
  - Providing the name, description, photo url, **bid ending date and time,** starting price and purchase price for the item
  ...
  - **Given the bid ending date is not a correct date or it is in the past, the user can't create the item and the application displays a message about it**
...
### As a signed in user I can bid on a sellable item
  ...
  - **Given the id of an existing sellable item and a bid after the bid ending date, the bid is not saved and the application displays a message about it**
